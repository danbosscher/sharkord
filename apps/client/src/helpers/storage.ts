export enum LocalStorageKey {
  ...
  HIDE_INCOMING_VIDEO_STREAMS = 'sharkord-hide-incoming-video-streams',
  ENABLED_INCOMING_VIDEO_USER_IDS = 'sharkord-enabled-incoming-video-user-ids',
  ENABLED_INCOMING_SCREEN_SHARE_USER_IDS = 'sharkord-enabled-incoming-screen-share-user-ids',
  ENABLED_INCOMING_EXTERNAL_VIDEO_STREAM_IDS = 'sharkord-enabled-incoming-external-video-stream-ids',
