...
- complete enough for a real text-client prototype, including session resume, reconnect, explicit reply targeting, thread navigation, parent-message jumps from reply previews, attachment upload and viewing, persisted unread/read-state handling, typing indicators, and desktop notifications
